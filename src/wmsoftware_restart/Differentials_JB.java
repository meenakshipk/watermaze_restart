...
....................................................................*/
 /*------------------------------------------------------------------*/
    public void run(String arg) {
        ...
        } else if (!(imp.getProcessor().getPixels() instanceof float[])) {
...
//        cleanUpProgressBar();
    ...
    /* end run */
    public void run2(ImagePlus inputImp, int number) {
        this.imp = inputImp;
        if (imp == null) {
            IJ.noImage();
            return;
...
//    }
 ...
 /*------------------------------------------------------------------*/
    private void doIt(ImageProcessor ip) {
        int width = ip.getWidth();
        int height = ip.getHeight();
...
//                    stepProgressBar();
 ...
 /*------------------------------------------------------------------*/
    private void getColumn(ImageProcessor ip, int x, double[] column) {
        int width = ip.getWidth();
